...
Route::get('/migrate', [ArtisanCommandsController::class, 'migrate']);
Route::get('/test2', function (){
    return dd( substr("00967773569041", -9) );
});
Route::get('/app_link', [ArtisanCommandsController::class, 'app_link']);
Route::get('/role_seed', [ArtisanCommandsController::class, 'role_seed']);
Route::get('/seed', [ArtisanCommandsController::class, 'role_seed']);
Route::get('/clear', [ArtisanCommandsController::class, 'clearCache']);
Route::get('/optimize', [ArtisanCommandsController::class, 'optimizeCache']);
Route::get('/rout_cache', [ArtisanCommandsController::class, 'routeCache']);
Route::get('/clear_compiled', [ArtisanCommandsController::class, 'clearCompiled']);
Route::get('/storage_link', [ArtisanCommandsController::class, 'storageLnk']);
